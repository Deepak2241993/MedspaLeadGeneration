        ...
        <form method="POST" action="{{ route('admin.emails.index') }}" id="myForm">
            ...
            <div class="d-grid d-lg-flex d-md-flex action-bar">
                <div id="table-actions" class="flex-grow-1 align-items-center">
                    <button class="btn btn-danger btn-permanent-delete-selected" style="display:none;">Permanent
                        Delete</button>
                </div>
        ...
        <script>
            $(document).ready(function() {
                        ...
                        if (confirm('Are you sure you want to delete permanently?')) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    var table = $('.data-table').DataTable();
                                    table.row(harddeleteBtn.closest('tr')).remove().draw(
                                        false);
                                },
                ...
                $(document).on('click', '.restore', function() {
                    var id = $(this).data('id');
                    // Perform the action using the ID, e.g., make an AJAX request
